<template>
  <div class="min-h-screen bg-lightMarine p-4">
    <header
      class="bg-blue-600 text-white flex items-center p-4"
      style="height: 20vh"
    >
      <!-- Logo -->
...
// Use the public TTN endpoint via our local proxy in development
// or a CORS proxy in production
const API_URL = import.meta.env.DEV
  ? "/api/ttn2value/data/70B3D57ED007083A.json"
  : "https://corsproxy.io/?http://lukamali.com/ttn2value/data/70B3D57ED007083A.json";
